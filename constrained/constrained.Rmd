...
# Unconstrained optimization using Linear/Quadratic programming
...
Let us write the general for of an Unconstrained Quadratic Programming problem as the following:
