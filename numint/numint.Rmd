...
There are a variety of methods to perform numerical intregration, some of which you may have already learned in high school calculus.  We will review these methods plus commonly utilized ones in statistics, such as gaussian quadrature and monte carlo integration.  
...
Lets visualize some of the patient data before going further.  The following spagehetti plot shows the invididual patient trajectories: 
...
Alternatively, one may use the methods in the next section (particularly gauss-hermite quadrature) to approximate intergrals over the entire real line with very good accuracy. 
