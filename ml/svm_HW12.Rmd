...
Make a scatterplot that includes: the data points in this two
dimensional space, the "0" and "1" prediction space, and the decision
...
but before you attempt to `predict`, read further:
...
the other values. Then use this to run `predict` and define the
