...
where speed and memory usage are a critical factors.Some of the topics in this book, for example usage of *Rcpp* and
...
Additional detail can be found in Section 7.5 of the Efficient R Programming book. 
