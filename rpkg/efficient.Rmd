...
We don't have time to sufficiently cover this in this note, but it's worth reading on your own.  Some of the topics in this book, for example usage of *Rcpp* and *data.table* will be covered in later lecture notes.
...
\int_0^1 x^2 dx
\]
using a Monte-Carlo Integration We will learn more about this in Module 2, but for now, we focus on the programming aspect.
