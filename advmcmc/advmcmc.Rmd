...
1.  Identifying a question in their selected dataset
2.  Identify a model to evaluate the question 
3.  Code up the model from scratch 
4.  Implement the model in an R package that uses knowledge from Module 1 
5.  Summarize results in R markdown document 
6.  Present the results in the last week of class 
